...
def launch_menu_choice():
    ...
    while True:
        display_main_menu()
        choice = ask_choice(
            "An opportunity for adventure lies before you. Seize it and live the adventure, or stay where you are and live the same life every day.",
            ["Start Adventure", "Exit the game"])
        if choice == 1:
